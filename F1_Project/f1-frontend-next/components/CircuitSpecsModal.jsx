    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 select-none">
        ...
        <motion.div 
          ...
          className="relative w-full max-w-2xl bg-[#090e1a] border border-cyan-500/40 rounded-3xl p-6 shadow-[0_0_60px_rgba(0,243,255,0.25)] space-y-6 z-10"
        >
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs font-mono text-slate-400 flex items-center gap-1 font-semibold">
          ...
          <div className="p-4 bg-slate-900/60 border border-slate-800 rounded-2xl space-y-3 font-mono text-xs">
            <div className="flex justify-between items-center">
              ...
              <span className="text-cyan-400 font-bold text-sm font-orbitron">{circuit.lap_record}</span>
            </div>
            ...
            <div className="flex justify-between items-center border-t border-slate-800/80 pt-2">
              ...
              <span className="text-white font-bold font-orbitron">{circuit.elevation_delta_m} METERS</span>
            </div>
          </div>
