...
import { Radio, Volume2, VolumeX, Gauge, Sliders, ChevronDown, Flag, Sparkles } from 'lucide-react';
...
export default function Navbar({ 
  ...
  return (
    <nav className="fixed top-5 left-1/2 -translate-x-1/2 z-50 w-[92%] max-w-6xl px-5 py-3 glass-panel-cyan rounded-2xl flex items-center justify-between shadow-[0_0_35px_rgba(0,0,0,0.8)] border border-cyan-500/30">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex flex-col">
          <span className="text-xs font-orbitron font-extrabold tracking-wider uppercase text-white flex items-center gap-1.5">
            PADDOCK 3D <span className="text-[10px] text-cyan-400 font-mono font-normal">v3.0</span>
          </span>
      ...
      <div className="hidden lg:flex items-center gap-8 text-xs font-mono text-slate-300">
        <a 
          ...
          className="hover:text-cyan-400 transition-colors uppercase font-bold tracking-wider hover:drop-shadow-[0_0_8px_rgba(0,243,255,0.6)]"
        >
          01. OVERVIEW
        </a>
        <a 
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-900/80 border border-slate-700/70 text-slate-200 text-xs font-mono hover:border-cyan-500/50 transition-all hover:text-cyan-400"
        >
        ...
        <div className="bg-slate-950/80 border border-slate-800 p-0.5 rounded-xl flex items-center text-[10px] font-mono font-bold">
          <button
            ...
            className={`px-2 py-1 rounded-lg transition-all ${
              unit === 'kmh' 
                ? 'bg-cyan-500 text-black shadow-[0_0_10px_rgba(0,243,255,0.5)]' 
        ...
        <div className="px-3 py-1 bg-red-600/15 border border-red-500/40 rounded-full text-red-400 text-xs font-mono flex items-center gap-1.5 shadow-[0_0_15px_rgba(225,6,0,0.2)]">
